...
} Cmd_Arg, *Ptr_Cmd_Arg;//variable Cmd_Arg is declared with arguement, with the pointer
...
} Cmd_Line, *Ptr_Cmd_Line;//anonymous, cmd_line is the only object, with pointer
