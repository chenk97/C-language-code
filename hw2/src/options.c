...
void/*default*/ look_for_person (person) char *person;
...
void/**/ print_people (Name_list *lst)

{
  ...
  // while (args != NIL) {
    ...
    // person = args -> option;
  // look_for_person(argv[i]);
  while(lst){
    char *person = lst->name;
